...
public strictfp class RobotPlayer {
    ...
    private static float danger(BulletInfo bullet) {
        ...
        float measure = bullet.getDamage() * bullet.location.distanceTo(rc.getLocation()) / (float) (angle + 0.00000001);
            ...
            while (true) {
                ...
                if (foes.length > 0) {
                    ...
                    if (largestThreat != null) {
                        ...
                        // if there is a very close bullet, evade the bullet
    ...
    private static void runArchon() throws GameActionException {
        ...
        while (true) {
            ...
            BulletInfo mostDangerousBullet = findMostDangerousBullet();

            if (mostDangerousBullet != null && rc.getLocation().distanceTo(mostDangerousBullet.getLocation()) < 5) {
                move = moveWithRandomBounce(rc.getLocation().directionTo(mostDangerousBullet.getLocation()).rotateLeftDegrees(120));
            } else {
                move = moveWithRandomBounce(move);
            }
